...
class AddSaleMen extends StatefulWidget {
  const AddSaleMen({super.key});

  @override
  State<AddSaleMen> createState() => _AddSaleMenState();
}

class _AddSaleMenState extends State<AddSaleMen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text(RoutesName.AddSaleMen),
      ),
      drawer: WgtNavebar(),
      body: SafeArea(
        child: Form(
